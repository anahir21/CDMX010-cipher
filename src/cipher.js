  ...
  encode: function (offset, texto) {
    ...
    for (let i = 0; i < texto.length; i++) {
      ...
      if (newtext >= 65 && newtext <= 90) {
        resultado += String.fromCharCode((newtext - 65 + offset) % 26 + 65);
      }//regresará si está en mayusculas
      else if (newtext >= 97 && newtext <= 122) {
        resultado += String.fromCharCode((newtext - 97 + offset) % 26 + 97);
      } //regresará cifrado si está en minusculas
      else {
